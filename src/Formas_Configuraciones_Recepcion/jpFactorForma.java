...
public class jpFactorForma extends javax.swing.JPanel {
    ...
    public void llenaTabla() {
        ...
        mdb.cargarInformacion2(modelo,5,"select ID_Forma1,ID_Forma2,Formula,Factor,Porcentaje from FactorForma where ID_Situacion=1");
    }
    ...
    public void busqueda() {
        ...
        if (txtBusquedaP.getText().length() > 0) {
            tipoP = " AND ID_Forma1 like '%" + txtBusquedaP.getText() + "%'";
        }
        if (txtBusquedaK.getText().length() > 0) {
            tipoK = " AND ID_Forma2 like '%" + txtBusquedaK.getText() + "%'";
        }
      /* if (txtBusquedaL.getText().length() > 0) {
            tipoL = "AND Formula like '%" + txtBusquedaL.getText() + "%'";
        }
     if (txtBusquedaÑ.getText().length() > 0) {
            tipoÑ = "AND Factor like '%" + txtBusquedaÑ.getText() + "%'";
        }**/
        String sql;
        System.out.println("SITUACION: " + situacion);
        if (situacion.equals("Todos")) {
            sql = "SELECT ID_Forma1,ID_Forma2,Formula,Factor,Porcentaje from FactorForma WHERE ID_Situacion<>3 "+tipoP+tipoK;
        } else {
            sql = "SELECT ID_Forma1,ID_Forma2,Formula,Factor,Porcentaje  from FactorForma WHERE ID_Situacion=" + situacion+tipoP+tipoK;
        }
