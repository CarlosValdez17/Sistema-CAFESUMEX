...
public class jdBoletaSalidaReceptor extends javax.swing.JDialog {
    ...
    public void llenarTablaIdCortes() {
        ...
        for (int i = 0; i < cadena.length; i++) {
            mdb.cargarInformacion2(modelo, 4, "select idLote, formaCafe, sacos, kg from cortesdeldia where idLote='" + cadena[i] + "'");
        }

        for (int i = 0; i < modelo.getRowCount(); i++) {
            totalSacos = totalSacos + Integer.parseInt(modelo.getValueAt(i, 2) + "");
            totalKg = totalKg + Float.parseFloat(modelo.getValueAt(i, 3) + "");
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Lote", "Forma de Café", "Sacos", "Kg"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String fechaBoletaManual = new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser1.getDate());
        ...
        for (int i = 0; i < modelo.getRowCount(); i++) {
            ...
            mdb.insertarEnCiclo("insert into boletasalidareceptor values (null, " + idSociedad + ", '" + idBoletaSalida + "', '" + idLote + "', " + txtBoletaManual.getText() + ", "
                    ...
                    + "'" + modelo.getValueAt(i, 2) + "', '"+modelo.getValueAt(i,3)+"', 'Enviado desde Receptor' )");
