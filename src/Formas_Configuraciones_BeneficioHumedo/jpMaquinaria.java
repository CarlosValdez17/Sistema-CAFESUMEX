...
public class jpMaquinaria extends javax.swing.JPanel {
    ...
    public jpMaquinaria(Connection c) {
        initComponents();
    ...
    public void busqueda() {
        ...
        if (txtBusquedaC.getText().length() > 0) {
            tipoC = " AND clave like '" + txtBusquedaC.getText() + "%'";
        }
        if (txtBusquedaF.getText().length() > 0) {
            tipoF = " AND factor like '" + txtBusquedaF.getText() + "%'";
        }
    ...
    private void initComponents() {
        ...
        if (tablaSobrante.getColumnModel().getColumnCount() > 0) {
            ...
            tablaSobrante.getColumnModel().getColumn(5).setResizable(false);
            tablaSobrante.getColumnModel().getColumn(6).setResizable(false);
            tablaSobrante.getColumnModel().getColumn(7).setResizable(false);
            tablaSobrante.getColumnModel().getColumn(8).setResizable(false);
            tablaSobrante.getColumnModel().getColumn(9).setResizable(false);
        }
