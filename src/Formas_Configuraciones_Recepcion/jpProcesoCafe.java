...
public class jpProcesoCafe extends javax.swing.JPanel {
    ...
    public jpProcesoCafe(Connection c) {
        initComponents();
        cn = c;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdProcesoCafe(null, true, "1", Clave, TxTvar, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            JOptionPane.showMessageDialog(null,"selecciona un registro");
             ...
             jdR = new jdProcesoCafe(null, true, "2",Clave, TxTvar ,cn);
        jdR.jp = this;
        jdR.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql = "UPDATE ProcesoCafe SET ID_Situacion=2 where Clave='" + Clave+ "'";
