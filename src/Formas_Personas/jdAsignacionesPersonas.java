...
public class jdAsignacionesPersonas extends javax.swing.JDialog {
    ...
    public jdAsignacionesPersonas(java.awt.Frame parent, boolean modal, String tipo, String valor, Connection c) {
        super(parent, modal);
        initComponents();
    ...
    public void llenarTabla() {
        ...
        mdb.cargarInformacion2(modelo, 1, "select descripcion from puestos");
    }
    ...
    public void abrirFormulario(String formulario) {
        ...
        switch (formulario) {
            case "Productor":
                jdFP = new jdFormularioProductor(null, true,cn);
