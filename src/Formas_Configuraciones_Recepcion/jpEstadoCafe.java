...
public class jpEstadoCafe extends javax.swing.JPanel {
    ...
    public jpEstadoCafe(Connection c) {
        initComponents();
        cn = c;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Estado De Cafe");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdEstadoCafe(null, true, "1", Clave, TxTvar, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            JOptionPane.showMessageDialog(null,"selecciona un registro");
             ...
             jdR = new jdEstadoCafe(null, true, "2",Clave, TxTvar ,cn);
        jdR.jp = this;
        jdR.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql = "UPDATE EstadoCafe SET ID_Situacion=2 where Clave='" + Clave+ "'";
